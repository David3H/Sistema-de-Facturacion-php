	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS UTA</span>
					<p>Av. de Los Chasquis y Rio Payamino, Ambato</p>
					<p>Teléfono: 370-0090 ext. 83551 032 521081 Ext. 114</p>
					<p>Email: direccion.posgrado@uta.edu.ec</p>
				</div>
			</td>
