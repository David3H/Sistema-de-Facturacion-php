			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>RUC / CI:</label><p><?php echo $factura['nit']; ?></p></td>
	...
	<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th class="textright" width="150px">P. Unitario</th>
			...
			<?php
						...
						$subtotal = number_format($subtotal + $precio_total, 2, '.', ',');
					}
				}
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="3" class="textright"><span>SUBTOTAL SIN IMPUESTOS</span></td>
					<td class="textright"><span><?php echo $tl_sniva; ?></span></td>
				</tr>
				<br>
				<tr>
					<td colspan="3" class="textright"><span>IVA (<?php echo round($iva); ?> %)</span></td>
					<td class="textright"><span><?php echo $impuesto; ?></span></td>
				</tr>
				<br>
				<tr>
					<td colspan="3" class="textright"><span>VALOR TOTAL</span></td>
					<td class="textright"><span><?php echo $total; ?></span></td>
				</tr>
		</tfoot>
	</table>
	<div>
		<p class="nota">Si usted tiene preguntas sobre esta factura, 
			<br>pongase en contacto con: 
			<br>Remuck PC 
			<br>Tel: 0912345678 
			<br>Email: empresa@gmail.com</p>
			<br>
